...
define('SONOS_CLIENT_ID', 'e7d7f43a-b59a-4889-8b49-d76ff3bd87b5');
define('SONOS_CLIENT_SECRET', 'eb76b0ba-ecbf-4237-9ba8-3e01c4972416');
...
define('SONOS_REDIRECT_URI', 'https://code.shinytoys.xyz/playbox/callback.php');
...
define('TOKEN_FILE_PATH', '/home/dh_dz9jks/sonos_tokens/tokens.json');

// Step 4: Configure Household ID and Target Player Name
define('SONOS_HOUSEHOLD_ID', 'Sonos_cuxjTaw3pj9NVbd38trzquOsSj.kMuY_elYbj8-1O7u2nhQ');

// This is the name of the speaker you want to control.
// It must exactly match the name in your Sonos app.
define('SONOS_PLAYER_NAME', 'Sadie\'s Room');
